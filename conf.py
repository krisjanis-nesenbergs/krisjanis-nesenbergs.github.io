...
BLOG_AUTHOR = "Krisjanis Nesenbergs"  # (translatable)
BLOG_TITLE = "Krisjanis Nesenbergs - notebook"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://krisjanis-nesenbergs.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://krisjanis-nesenbergs.github.io/"
BLOG_EMAIL = "name.surname@gmail.com"
BLOG_DESCRIPTION = "Random notes of things in my head."  # (translatable)
